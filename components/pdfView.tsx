...
// gsutil cors set cors.json gs://pdfbot-8fd78.appspot.com
// go here >>> https://console.cloud.google.com/
// create new file in editor calls cors.json
// run >>> // gsutil cors set cors.json gs://pdfbot-8fd78.appspot.com
...
function PdfView({ url }: { url: string }) {
  ...
  return (
    <div className="flex flex-col justify-center items-center">
      <div className="sticky bg-indigo-600 top-0 z-50 p-2 rounded-b-lg">
